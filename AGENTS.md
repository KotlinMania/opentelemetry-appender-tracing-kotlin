...
This file is the quick-reference operating contract for opentelemetry-appender-tracing-kotlin. The longer
...
opentelemetry-appender-tracing-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`opentelemetry-appender-tracing`](https://crates.io/crates/opentelemetry-appender-tracing). Upstream Rust is the behavioral oracle while the
