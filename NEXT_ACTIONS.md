...
- **Class/type parity:** 3/7 matched (target 23) — 42.9%
- **Combined symbol parity:** 25/51 matched (target 72) — 49.0%
...
| Source | Target | Path |
|--------|--------|------|
| `opentelemetry-appender-tracing.lib` | `opentelemetryappendertracing.Lib` | `opentelemetry-appender-tracing/src/lib` |
